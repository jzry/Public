...
class Graph
{
    ...
    // Remove the edges.
    public void removeEdge(int i, int j, double weight)
    {
        adjMatrix[i][j] = weight;
        adjMatrix[j][i] = weight;
    }
...
class MST
{
    ...
    int minKey(double[] key, Boolean[] mstSet, int numOfVertices)
    {
        V = numOfVertices;
    ...
    void printMST(double[] parent, double[][] graph, int numOfVertices)
    {
        V = numOfVertices;
    ...
    void primMST(double graph[][], int numVertices)
    {
        V = numVertices;
